...
<div class="panel-group col-xs-12" id="result-{{ $blockId }}" data-type="result" data-id="{{ $dataId }}" style="margin: 20px 0 0 0">
    <div class="panel panel-default">
        ...
        <div id="collapseResult-{{ $blockId }}" class="panel-collapse collapse" aria-expanded="false">
            <div class="panel-body">
                ...
                {!! Form::wysiwyg('short_description', $item->getAttributes()['short_description'], [
                    'label' => [
                ...
                {!! Form::wysiwyg('full_description', $item->getAttributes()['full_description'], [
                    'label' => [
