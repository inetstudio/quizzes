...
namespace InetStudio\Quizzes\Console\Commands;
...
class SetupCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'inetstudio:quizzes:setup';
    ...
    private function initCommands(): void
    {
        $this->calls = [
            [
                ...
                'params' => [
                    '--provider' => 'InetStudio\Quizzes\Providers\QuizzesServiceProvider',
                    '--tag' => 'migrations',
                ],
            ],
            [
            ...
            [
                ...
                'command' => 'inetstudio:quizzes:folders',
            ],
            [
                'type' => 'artisan',
